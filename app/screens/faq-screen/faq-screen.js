...
const languageLinks = {
  English: 'https://heradigitalhealth.org/frequently-asked-questions/',
  Arabic: 'https://heradigitalhealth.org/ar/frequently-asked-questions/',
  Turkish: 'https://heradigitalhealth.org/tr/sikca-sorulan-sorular/',
};
  ...
  return (
    <View style={styles.FULL}>
      <SafeAreaView style={styles.SAFE_AREA_VIEW}>
        <ToolBar
          title={t('faq_screen_toolbar_title')}
