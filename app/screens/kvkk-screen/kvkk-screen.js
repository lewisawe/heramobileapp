...
const languageLinks = {
  English: 'https://heradigitalhealth.org/data-protection-policy/',
  Arabic: 'https://heradigitalhealth.org/ar/data-protection-policy/',
  Turkish:
    'https://heradigitalhealth.org/tr/kisisel-verilerin-korunmasi-politikasi/',
};

export const KVKKScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.FULL}>
      <SafeAreaView style={styles.SAFE_AREA_VIEW}>
        <ToolBar title={t('kvkk_toolbar_title')} navigation={navigation} />
      </SafeAreaView>
